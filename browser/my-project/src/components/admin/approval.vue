<template>
  <div>
    <el-table :data="tableData" border style="width: 100%;">
      <el-table-column prop="name" label="报修用户" width="150" align="center"></el-table-column>
      <el-table-column prop="phone" label="联系电话" width="150" align="center"></el-table-column>
      <el-table-column prop="location" label="维修地址" width="150" align="center"></el-table-column>
      <el-table-column prop="content" label="维修内容" width="180" align="center"></el-table-column>
      <el-table-column prop="mode" label="状态" width="180" align="center"></el-table-column>
    ...
    <el-dialog title="请选择维修员" :visible.sync="dialogFormVisible">
      <el-form :model="form">
